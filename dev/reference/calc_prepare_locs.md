...
[`process_locs_vector()`](https://niehs.github.io/amadeus/dev/reference/process_locs_vector.md),
[`check_for_null_parameters()`](https://niehs.github.io/amadeus/dev/reference/check_for_null_parameters.md)
