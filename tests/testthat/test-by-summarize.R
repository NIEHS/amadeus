...
testthat::test_that("auxiliary .by helpers hit major branches and errors", {
  ...
  ymd8_bucket <- bucket_time_by_unit(c("20200101", "20200315"), "month")
  yyyymm_bucket <- bucket_time_by_unit(c("202001", "202003"), "month")
  yyyy_bucket <- bucket_time_by_unit(c("2020", "2021"), "year")
  ...
  testthat::expect_s3_class(ymd8_bucket, "Date")
  testthat::expect_s3_class(yyyymm_bucket, "Date")
  testthat::expect_s3_class(yyyy_bucket, "Date")
