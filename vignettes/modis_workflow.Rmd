...
```{r vegetation-template, eval = live_run}
...
```{r fire-mask-reference, echo = live_run, results = "asis"}
...
```{r fire-grid-template, eval = live_run}
...
```{r maiac-template, eval = live_run}
...
```{r blackmarble-template, eval = live_run}
